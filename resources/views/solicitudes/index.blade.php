...
@section('title',config('app.name').' | Listado de Solicitudes' )
    ...
    <section class="content-header">
        ...
        <h1 class="pull-right">
          @can('solicitud-create')
           <a class="btn btn-success pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('solfact.create') !!}">Agregar Nueva Solicitud</a>
          @endcan
