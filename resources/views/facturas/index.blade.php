            ...
            <div class="modal-body">
                ...
                <p> Para cargar un XML de una factura porfavor, seleccione primero el acuerdo al que se le asignará la factura.<p>
                  ...
                  <div class="form-group col-sm-12 col-lg-12">
                      ...
                      {!! Form::select('cliente_id2', $clientes, null, ['class' => 'form-control select2', 'placeholder' => 'Seleccione un cliente', 'required', 'style'=>'width: 100%;']) !!}
                  </div>
                <!-- combobox de acuerdos comerciales -->
                <div class="form-group col-sm-12 col-lg-12">
                    {!! Form::label('acuerdo', 'Acuerdo Comercial:') !!}
                    {!! Form::select('acuerdo', $acuerdos, null, ['class' => 'form-control select2', 'placeholder'=>'Seleccione un acuerdo','required','style'=>'width: 100%;']) !!}
                </div>
...
@endsection
  ...
  @can('facturas-createxml')
  $('#cliente_id2').on('change', function(e) {
    //console.log(e);
    var cliente_id = e.target.value;
    //ajax
    $.get('{{url('facturas/GetAcuerdosCliente')}}/'+cliente_id, function(data) {
      ...
      console.log(data);
      $('#acuerdo').empty();
      $('#acuerdo').append('<option value ="0">Seleccione una opción</option>' );
      $.each(data, function(index, acuerdo) {
        $('#acuerdo').append('<option value ="' + acuerdo.id + '">'+acuerdo.numacuerdo+'</option>' );
      });
    });
  });
  @endcan
