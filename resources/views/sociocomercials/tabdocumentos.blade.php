...
@can('documentos-list')
    <div class="box box-primary">
      <div class="box-header">
        <h3 class="box-title">Documentos del Asociado Comercial</h3>
        <div class="box-tools pull-right">
          ...
          <!-- /.box-header -->
              <div class="box-body">
      @if($sociocomercial->documentos->count()>0)
      ...
      @foreach($sociocomercial->documentos as$key=>$documento)
        <tr>
          <td>{{$key+1}}</td>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
              {!! Form::open(['url' => 'sociocomercial/documento', 'enctype' => 'multipart/form-data']) !!}

          {!! Form::hidden('socio_id', $sociocomercial->id) !!}
          {!! Form::hidden('redirect', 'sociocomercials.show') !!}
