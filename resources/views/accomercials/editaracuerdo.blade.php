...
<div class="form-group">
    ...
    {!! Form::date('fechasolicitud', date("Y-m-d"), ['class' => 'form-control disabled', 'required', 'disabled']) !!}
...
<!-- Sociocomer Id Field -->
  <div class="form-group">
      ...
      {!! Form::select('sociocomer_id', $sociocomer,  $accomercial->sociocomer_id, ['class' => 'form-control select2', 'style'=>'width: 100%;','placeholder'=>'Seleccione uno', 'required']) !!}
  </div>
  ...
  <div class="form-group">
      ...
      <div class="input-group">
        ...
        {!! Form::number('asoc_comision', $accomercial->asoc_comision, ['class' => 'form-control', 'step'=>'0.01', 'max' => '15.00', 'placeholder'=>'Porcentaje comisionable']) !!}
...
<div class="form-group">
    ...
    {!! Form::select('cliente_id', $clientes, null, ['class' => 'form-control select2', 'style'=>'width: 100%;', 'required', 'placeholder'=>'Seleccione uno', 'disabled']) !!}
</div>
...
<div class="form-group">
    ...
    {!! Form::select('empresasasoc[]', $empresas, $empresassel, ['class' => 'form-control select2', 'required', 'multiple'=>'multiple', 'data-placeholder'=>'Seleccione una empresa', 'style'=>'width: 100%;']) !!}
</div>
...
<div class="input-group">
    ...
    {!! Form::number('ac_principalporc', null, ['class' => 'form-control', 'required', 'step'=>'0.01', 'max' => '15.00', 'min'=>'0.09', 'disabled']) !!}
    <span class="input-group-addon">%</span>
</div>
</div>
...
<div class="form-group">
    ...
    {!! Form::number('ac_secundarioporc', null, ['class' => 'form-control', 'step'=>'0.01', 'max' => '15.00', 'min'=>'0.09', 'disabled']) !!}
    <span class="input-group-addon">%</span>
</div>
</div>
...
<div class="form-group">
    ...
    {!! Form::select('base', ['SUBTOTAL'=>'SUBTOTAL','DEVOLUCION'=>'DEVOLUCION','TOTAL'=>'TOTAL'],null, ['class' => 'form-control', 'required', 'placeholder'=>'Seleccione', 'disabled']) !!}
</div>

<!-- Elab User Id Field -->
<div class="form-group">
    {!! Form::label('elab_user_id', 'Usuario que Elabora:*') !!}
    {!! Form::select('elab_user_id', $usuarios, Auth::user()->id, ['class' => 'form-control', 'readonly','required', 'onsubmit'=>'enableElabUser();', 'disabled' ]) !!}
