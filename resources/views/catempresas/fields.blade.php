                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-xs-6">
                            ...
                            {!! Form::text('ciudad', null, ['class' => 'form-control', 'list'=>'listaciudad', 'placeholder'=>'ciudad', 'required']) !!}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('colonia', null, ['class' => 'form-control', 'list'=>'listacolonias', 'placeholder'=>'Colonia', 'required']) !!}
                    </div>
...
$('#giroempresa').on('change keyup paste', function(e) {
  ...
  timeout = setTimeout(function () {
      ...
      //ajax
      if (palabra.length >= 3  ) {
        $.get('{{url('/GetGiro')}}?word='+palabra, function(data) {
