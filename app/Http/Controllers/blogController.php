...
class blogController extends AppBaseController
{
    ...
    public function store(CreateblogRequest $request)
    {
        ...
        Alert::success('Datos guardados correctamente.', 'Blog');
    ...
    public function show($id)
    {
        ...
        if (empty($blog)) {
            Flash::error('Blog no encontrado');
            Alert::error('Blog no encontrado.', 'Blog');
    ...
    public function update($id, UpdateblogRequest $request)
    {
        ...
        Flash::success('Blog actualizado correctamente.');
        Alert::success('Blog actualizado correctamente.', 'Blog');
    ...
    public function destroy($id)
    {
        ...
        Alert::success('Blog borrado correctamente.', 'Blog');
